      ...
      <Dialog open={isCanvasDialogOpen} onOpenChange={setIsCanvasDialogOpen}>
        <DialogContent showCloseButton={false} className="rounded-2xl p-6">
          <DialogHeader className="gap-2">
            <DialogTitle>Chuyển tới ứng dụng bên thứ ba</DialogTitle>
            <DialogDescription className="text-sm leading-6">
              Lối vào này chỉ dành cho thử nghiệm cá nhân; khuyến nghị tự triển khai trên máy của bạn trước khi dùng lâu dài. Địa chỉ chuyển hướng mặc định sẽ kèm theo địa chỉ dự án này và khóa hiện tại để tự động điền thông tin kết nối; nếu không yên tâm, bạn có thể hủy rồi tự vào ứng dụng và nhập thủ công.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-2">
            <div className="text-xs font-medium text-stone-500">Địa chỉ chuyển hướng đầy đủ</div>
