      ...
      <CardContent className="space-y-6 p-6">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500">Cấu hình kết nối trước, sau đó truy vấn tài khoản từ xa và chọn nhập vào pool cục bộ khi cần.</p>
            </div>
          </div>
        ...
        {isLoadingPools ? (
          ...
          <div className="flex flex-col items-center justify-center gap-3 rounded-xl bg-stone-50 px-6 py-10 text-center">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-stone-400">Nhấn “Thêm kết nối” để lưu thông tin CLIProxyAPI của bạn.</p>
            </div>
          </div>
        ) : (
        ...
        <div className="rounded-xl bg-stone-50 px-4 py-3 text-sm leading-6 text-stone-500">
          ...
          <ul className="mt-1 list-inside list-disc space-y-0.5">
            <li>Khi vào trang sẽ đọc trước các kết nối CPA đã cấu hình trong hệ thống.</li>
            <li>Sau khi nhấn “Đồng bộ” ở một kết nối, hệ thống đọc danh sách tài khoản từ xa và hiển thị để chọn.</li>
            <li>Sau khi xác nhận, backend tải access_token tương ứng ở nền và nhập vào pool cục bộ.</li>
            <li>Frontend chỉ theo dõi tiến trình nhập, không trực tiếp tham gia download.</li>
          </ul>
        </div>
      </CardContent>
    </Card>
