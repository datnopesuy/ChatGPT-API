...
export function ProxySettingsCard() {
  ...
  const load = async () => {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : "Tải cấu hình proxy thất bại");
    } finally {
      setIsLoading(false);
    }
  };
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500">
                Cấu hình proxy ra mạng cho các request tới chatgpt.com, phù hợp khi triển khai máy chủ trong nước; request Sub2API / CPA không bị ảnh hưởng.
              </p>
            </div>
          </div>
        </div>
            ...
            <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-stone-200 bg-white px-4 py-3">
              ...
              <div className="space-y-0.5">
                ...
                <div className="text-sm text-stone-500">
                  Khi tắt, request tới chatgpt.com sẽ kết nối trực tiếp. Lưu xong có hiệu lực ngay, không cần khởi động lại.
                </div>
              </div>
            </label>
